...
export default function SupportBadge() {
 ...
 useEffect(() => {
  ...
  return (
    ...
    }} className={`border ${data.imageSrc ? 'hidden':''} fixed bottom-1 right-5 max-md:bottom-[120px] rounded-[0.3rem] _support_messages p-2 mb-5 flex items-center bg-white shadow`}>
      {expand && <div>
