      ...
      <div class={`flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 ${ comment.user_id != user?.id ? 'bg-gray-100':'bg-honolulu_blue-50'} rounded-e-xl rounded-es-xl`}>
         <div class={`flex items-start ${ comment.user_id != user?.id ? 'bg-gray-50':'bg-honolulu_blue-100'}  rounded-xl p-2`}>
            ...
            <div class="inline-flex self-center items-center">
               <button onClick={()=>data.handleDownload(comment.filename)} class="inline-flex cursor-pointer hover:opacity-80 self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50" type="button">
