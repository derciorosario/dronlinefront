...
<div className={`w-[400px] border ${!show ? 'translate-x-[100%]' : ''} transition-all ease-in delay-75 rounded-md h-[80vh] bg-white relative`}>
       ...
       <div id="toast-notification" class="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow" role="alert">
