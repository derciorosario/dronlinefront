                                    ...
                                    <li onClick={()=>setShowDoctorDetails(true)} class="py-3 sm:py-4 hover:bg-gray-100 px-4 rounded-[0.3rem] cursor-pointer">
                                        <div class="flex items-center">
                                            ...
                                            <div class="inline-flex items-center  text-base font-semibold text-gray-900">
                                                 <span>{t('common.'+i.medical_specialty)}</span>
                                                 <div className="w-[1px] h-[25px] bg-[rgba(0,0,0,0.5)] mx-3">

                                                 </div>
                                                 <div className="cursor-pointer hover:opacity-65 active:opacity-75">
