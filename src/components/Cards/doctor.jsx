            ...
            <div class="p-5">
                ...
                <div className="flex gap-3 bg-white py-2 px-1 border-t mb-6">
                           ...
                           <div className="flex flex-col items-center">
                               ...
                               <span className="text-[13px] flex justify-center flex-wrap">{t('common.rating')} <label className="ml-1">({data.getFakeConsultationCount(0,5)[item.id]}{/*item.average_rating.toString().slice(0,3)*/})</label></span>
                           </div>
                           ...
                           <div onClick={()=>{
                               ...
                               <span className="text-[13px] flex justify-center flex-wrap">{t('common.reviews')} <label className="ml-1">({data.getFakeConsultationCount(0,4)[item.id] + item.reviews?.length})</label></span>
                           </div>
                    </div>
