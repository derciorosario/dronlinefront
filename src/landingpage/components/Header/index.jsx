       ...
       <div>
           ...
           <div className="w-full flex border-b  items-center bg-white justify-between px-[50px] max-md:px-[25px] z-40 absolute  left-0 top-0"> 
             ...
             <div className="flex items-center _lang">
               ...
               <div className="mr-5 flex items-center  mb-2">
                  <button type="button" onClick={()=>{
                     navigate('/register')
                  }} class="text-white max-sm:hidden bg-honolulu_blue-400 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2">{t('common.register')}</button>
                  <button type="button" onClick={()=>{
                    if(user){
                  ...
                  }} class="py-2.5  px-5 me-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">Login</button>
               </div>
  ...
  return (
    <div className="w-full bg-[rgba(255,255,255,0.8)]  max-md:px-[20px] px-[60px] py-4 flex items-center justify-between relative">
          <div className="absolute -bottom-5 right-0 bg-honolulu_blue-500  rounded-l-[1rem] px-2 py-1 ">
             <span className="text-white">{t('common.available-24')}</span>
          </div>
          ...
          <div>
             <img  onClick={()=>{
                    navigate('/')
                    goto()
               }} src={BlackLogo} className="w-[140px] max-md:w-[125px] max-sm:w-[100px] cursor-pointer"/>    
          </div>

          <div className="flex items-center">
              {data._loaded.includes('settings') && <div className="flex items-center">
                   ...
                   <div className="flex flex-col">
                      ...
                      <span className="text-[25px] max-md:text-[13px] font-medium text-honolulu_blue-500">+{data.app_settings?.main_contact_code} {data.app_settings?.main_contact}</span>
                   </div>
