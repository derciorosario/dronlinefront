 ...
 async function SubmitForm(){
  ...
  return (
     <DefaultLayout hide={ShowOnlyInputs}>
           ...
           <FormLayout hideInputs={user?.role=="doctor"} hide={!itemToEditLoaded && id} hideTitle={ShowOnlyInputs} title={'Adicionar paciente'} verified_inputs={verified_inputs} form={form} bottomContent={(
                 <>
