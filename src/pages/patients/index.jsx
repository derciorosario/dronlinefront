                   ...
                   <div className="flex w-full relative">
                       ...
                       body={data._patients?.data?.map((i,_i)=>(
                              ...
                              <BaiscTable.Tr>
                                ...
                                <BaiscTable.Td url={`/patient/`+i.id}>{i.created_at.split('T')[0]?.split('-')?.reverse()?.join('/') + " "+i.created_at.split('T')[1].slice(0,5)}</BaiscTable.Td>
                                <BaiscTable.Td url={`/patient/`+i.id}>{i.updated_at?.split('-')?.reverse()?.join('/') ? i.updated_at.split('T')[0]?.split('-')?.reverse()?.join('/') + " " +i.updated_at.split('T')[1].slice(0,5) : i.created_at.split('T')[0]?.split('-')?.reverse()?.join('/') + " "+i.created_at.split('T')[1].slice(0,5)}</BaiscTable.Td>
