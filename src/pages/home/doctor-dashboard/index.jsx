    ...
    <div className="w-full">
           ...
           {data._loaded.includes('doctor_dashboard') && <div>
             ...
             <DashboardCard topContent={(
              ...
              {hide:hideAmounts,name:t('common.total_amount_collected'),value:((data._doctor_dashboard?.totalInvoiceAmountByType?.payment || 0) - (data._doctor_dashboard?.totalInvoiceAmountByType?.refund || 0)),icon:(         
              ...
              {hide:hideAmounts,name:t('common.amount_earned'),value:getDoctorAmountEarned((data._doctor_dashboard?.doctor || {}), (data._doctor_dashboard?.totalInvoiceAmountByType?.payment || 0)),icon:(         
