           ...
           {data._loaded.includes('admin_dashboard') && <div>
             ...
             <DashboardCard topContent={(
               ...
               {!(user?.role=="manager" && !user?.data?.permissions?.payment_management?.includes('read')) && <div className="flex w-full justify-end absolute right-3 top-2">
                ...
                {hide:hideAmounts,name:t('common.total_amount_collected'),value:data._cn(parseFloat(data._admin_dashboard?.totalInvoiceAmountByType?.payment || 0).toFixed(2)),icon:(         
                ...
                {hide:hideAmounts,name:`Total IVA`,value:data._cn((parseFloat(data._admin_dashboard?.totalInvoiceAmountByType?.payment || 0) - parseFloat(data._admin_dashboard.totalPoint1)).toFixed(2)),icon:(         
                    <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M444-200h70v-50q50-9 86-39t36-89q0-42-24-77t-96-61q-60-20-83-35t-23-41q0-26 18.5-41t53.5-15q32 0 50 15.5t26 38.5l64-26q-11-35-40.5-61T516-710v-50h-70v50q-50 11-78 44t-28 74q0 47 27.5 76t86.5 50q63 23 87.5 41t24.5 47q0 33-23.5 48.5T486-314q-33 0-58.5-20.5T390-396l-66 26q14 48 43.5 77.5T444-252v52Zm36 120q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                )},

                {hide:hideAmounts,name:`${ t('common.total_amount_collected')} (- IVA)`,value:data._cn(parseFloat(data._admin_dashboard.totalPoint1).toFixed(2)),icon:(         
                    <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M444-200h70v-50q50-9 86-39t36-89q0-42-24-77t-96-61q-60-20-83-35t-23-41q0-26 18.5-41t53.5-15q32 0 50 15.5t26 38.5l64-26q-11-35-40.5-61T516-710v-50h-70v50q-50 11-78 44t-28 74q0 47 27.5 76t86.5 50q63 23 87.5 41t24.5 47q0 33-23.5 48.5T486-314q-33 0-58.5-20.5T390-396l-66 26q14 48 43.5 77.5T444-252v52Zm36 120q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                )},

                {hide:hideAmounts,name:`${t('common.amount_earned')} (${t('common.doctors')})`,value:data._cn((parseFloat(data._admin_dashboard.totalPoint2)).toFixed(2)),icon:(         
                    <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M444-200h70v-50q50-9 86-39t36-89q0-42-24-77t-96-61q-60-20-83-35t-23-41q0-26 18.5-41t53.5-15q32 0 50 15.5t26 38.5l64-26q-11-35-40.5-61T516-710v-50h-70v50q-50 11-78 44t-28 74q0 47 27.5 76t86.5 50q63 23 87.5 41t24.5 47q0 33-23.5 48.5T486-314q-33 0-58.5-20.5T390-396l-66 26q14 48 43.5 77.5T444-252v52Zm36 120q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                )},

                {hide:hideAmounts,name:`${t('common.amount_earned')}  (Dr Online)`,value:data._cn((parseFloat(data._admin_dashboard.totalPoint1) - parseFloat(data._admin_dashboard.totalPoint2)).toFixed(2)),icon:(         
                    <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M444-200h70v-50q50-9 86-39t36-89q0-42-24-77t-96-61q-60-20-83-35t-23-41q0-26 18.5-41t53.5-15q32 0 50 15.5t26 38.5l64-26q-11-35-40.5-61T516-710v-50h-70v50q-50 11-78 44t-28 74q0 47 27.5 76t86.5 50q63 23 87.5 41t24.5 47q0 33-23.5 48.5T486-314q-33 0-58.5-20.5T390-396l-66 26q14 48 43.5 77.5T444-252v52Zm36 120q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                )},

                {hide:hideAmounts,name:`${t('common.amount_earned')} (${t('common.doctors')}) - IRPS`,value:data._cn(parseFloat(data._admin_dashboard.totalPoint3).toFixed(2)),icon:(         
                    <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M444-200h70v-50q50-9 86-39t36-89q0-42-24-77t-96-61q-60-20-83-35t-23-41q0-26 18.5-41t53.5-15q32 0 50 15.5t26 38.5l64-26q-11-35-40.5-61T516-710v-50h-70v50q-50 11-78 44t-28 74q0 47 27.5 76t86.5 50q63 23 87.5 41t24.5 47q0 33-23.5 48.5T486-314q-33 0-58.5-20.5T390-396l-66 26q14 48 43.5 77.5T444-252v52Zm36 120q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                )},

                {hide:hideAmounts,name:`Total IRPS`,value:data._cn(parseFloat(data._admin_dashboard.totalPoint2) - (parseFloat(data._admin_dashboard.totalPoint3)).toFixed(2)),icon:(         
                    <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M444-200h70v-50q50-9 86-39t36-89q0-42-24-77t-96-61q-60-20-83-35t-23-41q0-26 18.5-41t53.5-15q32 0 50 15.5t26 38.5l64-26q-11-35-40.5-61T516-710v-50h-70v50q-50 11-78 44t-28 74q0 47 27.5 76t86.5 50q63 23 87.5 41t24.5 47q0 33-23.5 48.5T486-314q-33 0-58.5-20.5T390-396l-66 26q14 48 43.5 77.5T444-252v52Zm36 120q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                )},
                 ...
                 <div className="w-full">
                        ...
                        <BaiscTable canAdd={false} hide={topClients.length==0}   loaded={data._loaded.includes('admin_dashboard')} header={[
                                    ...
                                    body={topClients.filter(i=>i.role==selectedTab2).map((i,_i)=>(
                                        <BaiscTable.Tr>
                                            <BaiscTable.Td url={!i.name ? null : `/${selectedTab2}/`+i.id}>{i.id || '-'}</BaiscTable.Td>
                                            <BaiscTable.Td url={!i.name ? null : `/${selectedTab2}/`+i.id}>{i.name || t('common.dronline-team')}</BaiscTable.Td>
                                            <BaiscTable.Td url={!i.name ? null : `/${selectedTab2}/`+i.id}>{i.email || '-'}</BaiscTable.Td>
                                            <BaiscTable.Td url={!i.name ? null : `/${selectedTab2}/`+i.id}>{i.appointment_count}</BaiscTable.Td>
                                            <BaiscTable.Td url={!i.name ? null : `/${selectedTab2}/`+i.id}>{i.medical_specialties.map(c=>data._specialty_categories.filter(f=>f.id==c)[0]?.[i18next.language+"_name"]).filter(f=>f).join(', ')}</BaiscTable.Td>
