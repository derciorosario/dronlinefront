...
function SystemPage({form,setForm}) {
       ...
       <div>
            <div className="flex gap-x-4 flex-wrap mt-4">
                              ...
                              <div className="w-[300px] flex items-center justify-center bg-gray-300 h-[100px] rounded-[0.3rem]">
                                    {!form?.app_settings?.value?.stamp_filename &&  <svg class="w-8 h-8 stroke-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {form?.app_settings?.value?.stamp_filename && <img className="object-cover border w-auto h-full" src={form?.app_settings?.value?.stamp_filename}/>}
