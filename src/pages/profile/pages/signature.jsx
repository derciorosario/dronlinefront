  ...
  return (
    <div className="w-full">
                    <div className="gap-x-4 flex-wrap mt-4">
                                    {(form.id) && <FileInput onlyImages={true} _upload={{key:'signature_filename',filename:form.signature_filename}} res={handleUploadedFiles} label={t('common.signature')}/>}
                      ...
                      <div className="gap-x-4 flex-wrap mt-4">
                                     {(form.id) && <FileInput  onlyImages={true} _upload={{key:'stamp_filename',filename:form.stamp_filename}} res={handleUploadedFiles} label={t('common.stamp')}/>}
                                    <div className="w-[300px] flex items-center justify-center bg-gray-300 h-[100px] rounded-[0.3rem]">
